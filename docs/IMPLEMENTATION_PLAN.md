...
- La cuenta tiene registrado `marcobacchetta95.workers.dev`. La sesión remota temporal confirmó en Cloudflare las redirecciones por idioma, el fallback, la preferencia manual, la conservación de parámetros y las rutas explícitas. No se ejecutó un despliegue persistente ni se modificó producción.
